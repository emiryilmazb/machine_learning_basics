...
- **Outlier Handling:** Remove outliers from numerical columns using the IQR (Interquartile Range) method.
...
- **Before & After View:** A dedicated tab to visually and statistically compare the dataset before and after pre-processing steps. This helps in understanding the impact of outlier removal and scaling on data distribution.
...
├── new_app.py              # Main Streamlit application file
